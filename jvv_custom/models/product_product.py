...
class ProductProduct(models.Model):
    ...
    count_mrp_productions = fields.Integer(
        ...
        compute='_compute_count_mrp_productions', store=True)
    last_ldm_total_cost = fields.Float(
        string='Last Manufacturing LdM Total Cost',
        related='last_mrp_id.ldm_total_cost', store=True, copy=False)
    product_category = fields.Char(
        sring="Categoría producto", related="categ_id.name", store=True,
        copy=False)
