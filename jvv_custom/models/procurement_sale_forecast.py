...
class ProcurementSaleForecast(models.Model):
    ...
    @api.depends("forecast_lines2_ids",
                 "forecast_lines2_ids.completed_line")
    ...
    forecast_lines2_ids = fields.One2many(
        ...
        inverse_name='forecast_id', string="Forecast Lines to sale orders")
    sale_order_ids = fields.Many2many(
        string="Forecast lines in sale orders", comodel_name="sale.order",
        relation="rel_sale_forecast_sale_order",
        column1="forecast_id", column2="sale_order_id", copy=False,
        readonly=True)
